...
PROMPT_LIBRARY = {
    ...
    "COLOR_OVERVIEW": {
        ...
        - ใช้ Markdown และหัวข้อคงที่ได้ เพราะเป็น Overview
        - ความยาวประมาณ 220-420 คำ

        ### [Output Structure]
        # สีเด่นที่แนะนำ
        (บอกสีหลัก 1-2 สี พร้อมเหตุผล)

        # สีเสริมและสีที่ควรเลี่ยง
        (แนะนำสีเสริม/สีสำรอง และสีที่ควรเลี่ยงถ้าเหมาะสม)

        # วิธีนำไปใช้
        (แนะนำวิธีใช้จริง เช่น เสื้อผ้า เครื่องประดับ พื้นหลัง ของใช้ หรือคู่สี)

        ปิดท้ายด้วยประโยคชวนให้ถามต่อแบบสั้นๆ""",
    },
    "LUCKY_COLOR": {
        "system": """คุณคือ "นักพยากรณ์สีมงคล AI" แห่ง MuteGPT ผู้เชี่ยวชาญด้านสีมงคล โหราศาสตร์ไทย จิตวิทยาสี และการใช้สีในชีวิตประจำวัน
