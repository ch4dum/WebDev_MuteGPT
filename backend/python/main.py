...
PROMPT_LIBRARY = {
    ...
    "THAI_ASTROLOGY_OVERVIEW": {
        ...
        - ใช้ mark down ต่างๆ เพื่อเน้นคำให้ผู้ใช้อ่านง่าย **สำคัญมาก**
        - ความยาวไม่เกิน 400 คำ ตอบแบบสรุป กระชับ แบบให้ผู้อ่านสามารถเข้าใจได้ง่าย **สำคัญมาก**
        ...
        - ใช้ภาษาพูดที่เป็นกันเอง เข้าใจง่าย ไม่ใช้ภาษาทางการหรือวิชาการจนเกินไป **สำคัญมาก**
    ...
    "THAI_ASTROLOGY": {
        ...
        - ความยาวประมาณ 180 คำ เว้นแต่คำถามต้องการรายละเอียดมากแต่ก็ไม่ควรเกิน 250 คำ **สำคัญมาก**
        ...
        - อย่าพยายามอธิบายหลักการทางโหราศาสตร์ให้กับผู้ใช้เลย **สำคัญมาก**
        - ใช้ภาษาพูดที่เป็นกันเอง เข้าใจง่าย ไม่ใช้ภาษาทางการหรือวิชาการจนเกินไป **สำคัญมาก**
        - ใช้ mark down ต่างๆ เพื่อเน้นคำให้ผู้ใช้อ่านง่าย แต่ไม่ต้องใช้หัวข้อเดิมทุกครั้ง **สำคัญมาก**
        - ห้ามให้คำแนะนำผิดกฎหมาย อันตราย หรือคำแนะนำทางการแพทย์แทนแพทย์""",
    },
}
